export function FeaturedProject () {
  return <article className="w-full cursor-pointer aspect-square group shadow-md border-neutral-800 border rounded-md overflow-hidden relative flex justify-center items-center">
