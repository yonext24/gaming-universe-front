...
export function ProductCard({ name, category_id, description, id, images, price, stock }: Product) {
  return (
    <article
      className="w-full cursor-pointer group aspect-square rounded-md overflow-hidden
   relative flex justify-center items-center"
    ...
    group-hover:scale-110 group-hover:rotate-1 transition-transform select-none"
      ...
      <ImageWithLoader
        ...
        alt="Product image"
        src={images?.image}
        className="h-3/4 w-3/4 relative z-10 m-auto object-contain"
      />
    ...
    border-2 border-transparent [border-image:_linear-gradient(to_bottom_right,yellow,_red,_yellow)_5] bg-clip-border"
      ...
      <div
        className="border border-neutral-700 bg-black rounded-full py-1
